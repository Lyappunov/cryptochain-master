...
// const ROOT_NODE_ADDRESS = isDevelopment ? `http://localhost:${DEFAULT_PORT}` : `https://thawing-tundra-11851.herokuapp.com`;
const ROOT_NODE_ADDRESS = `https://thawing-tundra-11851.herokuapp.com`;
